...
(function($){
    ...
    $.slickQuiz = function(element, options) {
        ...
        var defaults = {
            checkAnswerText:  '답을 골라보세요!',
            nextQuestionText: '다음 문제로',
            backButtonText: '',
            randomSort: false,
        ...
        plugin.method = {
            ...
            setupQuiz: function() {
                $(targets.quizName).hide().html(quizValues.info.name).fadeIn(1100, function(){$(this).fadeOut(2000);});
                $(targets.quizHeader).hide().prepend(quizValues.info.main).fadeIn(500);
